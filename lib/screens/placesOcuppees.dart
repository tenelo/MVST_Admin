...
class PlacesOccupees extends StatefulWidget {
  ...
  @override
  State<PlacesOccupees> createState() => _PlacesOccupeesState();
}

class _PlacesOccupeesState extends State<PlacesOccupees> {
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            const Spacer(),
                            if (stdCount > 0)
                              _TypeChip(label: 'Std $stdCount', isVip: false),
                            if (stdCount > 0 && vipCount > 0)
                              const SizedBox(width: 6),
                            if (vipCount > 0)
                              _TypeChip(label: 'VIP $vipCount', isVip: true),
                          ],
                        ),
                      ],
                    ),
                          ...
                          child: ElevatedButton(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Flexible(
                                  child: Text(
                                    "${d['depart']} -> ${d['destination']} ${formatHeure(d['heureDeDepart']?.toString() ?? '')} ",
