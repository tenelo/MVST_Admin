...
class _GraphiquesABarresAnneeState extends State<GraphiquesABarresAnnee> {
  ...
  ''';
    ...
    try {
      Results result = await _connection!.query(sql, [widget.annee]);
                  ...
                  child: SfCartesianChart(
                    ...
                    series: <CartesianSeries<MesDonneesTickets, String>>[
                      BarSeries<MesDonneesTickets, String>(
                        ...
                        color: Colors.orange,
                        name:
                            'Total des passagers pour l\'année ${widget.annee} : ${getTotalPassagers()}',
